...
const table = {
  en: [
    ...
    'Close', 'Pay 0.01 Pi', 'Processing...', 'Payment cancelled.', 'Payment failed. Please try again in Pi Browser.',
  ...
  ko: [
    ...
    '닫기', '0.01 Pi 결제', '처리 중...', '결제가 취소되었습니다.', '결제에 실패했습니다. Pi Browser에서 다시 시도해 주세요.',
  ...
  zh: [
    ...
    '关闭', '支付 0.01 Pi', '处理中...', '已取消支付。', '支付失败。请在 Pi Browser 中重试。',
  ...
  ja: [
    ...
    '閉じる', '0.01 Pi を支払う', '処理中...', '支払いがキャンセルされました。', '支払いに失敗しました。Pi Browserで再試行してください。',
  ...
  es: [
    ...
    'Cerrar', 'Pagar 0.01 Pi', 'Procesando...', 'Pago cancelado.', 'Pago fallido. Inténtalo de nuevo en Pi Browser.',
  ...
  pt: [
    ...
    'Fechar', 'Pagar 0.01 Pi', 'Processando...', 'Pagamento cancelado.', 'Pagamento falhou. Tente de novo no Pi Browser.',
  ...
  fr: [
    ...
    'Fermer', 'Payer 0.01 Pi', 'Traitement...', 'Paiement annulé.', 'Échec du paiement. Réessayez dans Pi Browser.',
  ...
  de: [
    ...
    'Schließen', '0.01 Pi zahlen', 'Wird verarbeitet...', 'Zahlung abgebrochen.', 'Zahlung fehlgeschlagen. Bitte im Pi Browser erneut versuchen.',
  ...
  id: [
    ...
    'Tutup', 'Bayar 0.01 Pi', 'Memproses...', 'Pembayaran dibatalkan.', 'Pembayaran gagal. Coba lagi di Pi Browser.',
  ...
  vi: [
    ...
    'Đóng', 'Thanh toán 0.01 Pi', 'Đang xử lý...', 'Đã hủy thanh toán.', 'Thanh toán thất bại. Thử lại trong Pi Browser.',
  ...
  th: [
    ...
    'ปิด', 'จ่าย 0.01 Pi', 'กำลังดำเนินการ...', 'ยกเลิกการชำระเงินแล้ว', 'ชำระเงินไม่สำเร็จ ลองใหม่ใน Pi Browser',
  ...
  hi: [
    ...
    'बंद', '0.01 Pi भुगतान', 'प्रोसेसिंग...', 'भुगतान रद्द।', 'भुगतान विफल। Pi Browser में फिर कोशिश करें।',
  ...
  ar: [
    ...
    'إغلاق', 'ادفع 0.01 Pi', 'جارٍ المعالجة...', 'أُلغي الدفع.', 'فشل الدفع. أعد المحاولة في Pi Browser.',
  ...
  ru: [
    ...
    'Закрыть', 'Оплатить 0.01 Pi', 'Обработка...', 'Оплата отменена.', 'Оплата не удалась. Повторите в Pi Browser.',
  ...
  tr: [
    ...
    'Kapat', '0.01 Pi öde', 'İşleniyor...', 'Ödeme iptal edildi.', 'Ödeme başarısız. Pi Browser’da tekrar deneyin.',
  ...
  it: [
    ...
    'Chiudi', 'Paga 0.01 Pi', 'Elaborazione...', 'Pagamento annullato.', 'Pagamento non riuscito. Riprova in Pi Browser.',
  ...
  pl: [
    ...
    'Zamknij', 'Zapłać 0.01 Pi', 'Przetwarzanie...', 'Płatność anulowana.', 'Płatność nieudana. Spróbuj w Pi Browser.',
  ...
  nl: [
    ...
    'Sluiten', 'Betaal 0.01 Pi', 'Bezig...', 'Betaling geannuleerd.', 'Betaling mislukt. Probeer opnieuw in Pi Browser.',
  ...
  fil: [
    ...
    'Isara', 'Magbayad ng 0.01 Pi', 'Pinoproseso...', 'Kinansela ang bayad.', 'Hindi nagtagumpay ang bayad. Subukan ulit sa Pi Browser.',
  ...
  uk: [
    ...
    'Закрити', 'Сплатити 0.01 Pi', 'Обробка...', 'Оплату скасовано.', 'Оплата не вдалася. Спробуйте знову в Pi Browser.',
  ...
  bn: [
    ...
    'বন্ধ', '০.০১ Pi পরিশোধ', 'প্রসেস হচ্ছে...', 'পেমেন্ট বাতিল।', 'পেমেন্ট ব্যর্থ। Pi Browser-এ আবার চেষ্টা করুন।',
  ...
  ms: [
    ...
    'Tutup', 'Bayar 0.01 Pi', 'Memproses...', 'Pembayaran dibatalkan.', 'Pembayaran gagal. Cuba lagi dalam Pi Browser.',
  ...
  sw: [
    ...
    'Funga', 'Lipa 0.01 Pi', 'Inachakata...', 'Malipo yameghairiwa.', 'Malipo yameshindwa. Jaribu tena kwenye Pi Browser.',
  ...
  fa: [
    ...
    'بستن', 'پرداخت ۰٫۰۱ Pi', 'در حال پردازش...', 'پرداخت لغو شد.', 'پرداخت ناموفق. در Pi Browser دوباره تلاش کنید.',
  ...
  ur: [
    ...
    'بند', '۰.۰۱ Pi ادا کریں', 'پروسیسنگ...', 'ادائیگی منسوخ۔', 'ادائیگی ناکام۔ Pi Browser میں دوبارہ کوشش کریں۔',
