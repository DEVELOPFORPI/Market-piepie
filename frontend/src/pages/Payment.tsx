...
export const Payment: React.FC = () => {
  ...
  const handlePayment = async () => {
    ...
    // Simulated Pi Browser payment flow; production would use Pi SDK
      ...
      <div className="px-4 py-6 pb-24 space-y-6">
        ...
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg space-y-2">
          ...
          <ul className="text-sm text-yellow-800 space-y-1 list-disc list-inside">
            ...
            <li>The platform does not hold funds</li>
            <li>Open a dispute if something goes wrong</li>
            <li>Refunds are agreed between you and the seller</li>
          </ul>
        </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg text-center">
            {status === 'opening' && (
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-gray-600">Opening Pi payment…</p>
              </div>
            )}
